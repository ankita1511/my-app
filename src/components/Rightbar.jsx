    ...
    >
     <Box position="fixed" width={300}> 
        ...
        <ImageList cols={3} rowHeight={100} gap={5}>
          <ImageListItem>
              <img src="http://material-ui.com/static/images/image-list/breakfast.jpg"
              alt=" "/>
          </ImageListItem>
          <ImageListItem>
              <img src="http://material-ui.com/static/images/image-list/burgers.jpg"
              alt=" "/>
          </ImageListItem>
          <ImageListItem>
              <img src="http://material-ui.com/static/images/image-list/camera.jpg"
              alt=" "/>
          </ImageListItem>
        </ImageList>
        <Typography variant="h6" mt={2} mb={2} fontWeight={100}>Latest Convers</Typography>
